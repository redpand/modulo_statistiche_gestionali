	...
	<div id="tabs">
		...
		<div id="rientri_chart">
            <div id="filters_container" class="grafico-top-bar">                
                ...
                <button class="UI_buttons" onclick="CLBK_export_data_singolo_prodotto('<?php echo $prod_id; ?>');">
                    <img src="<?php echo base_url().PUBLIC_ADMIN_DIR.IMAGES_DIR?>excel_min.png" ><strong>Esporta</strong>
                </button>
            </div>
            <div id="rientri_container" class="grafico-box"></div>
...
$(document).ready(function(){
	...
	**********************************************************/
	...
	CBK_chart_statistiche('<?php echo $prod_id; ?>', "<?php echo $item['prod_descrizione']; ?>", resi, categories);
	
	$('#CMB_anno').val(data.getFullYear());
	
	$('#CMB_anno').change(function() {
		CBK_chart_statistiche('<?php echo $prod_id; ?>', "<?php echo $item['prod_descrizione']; ?>", null, null); return false;
	});
	...
	**********************************************************/
	...
	CBK_chart_rientri('<?php echo $prod_id; ?>', "<?php echo $item['prod_descrizione']; ?>");
	...
	$('#CMB_anno_fine').change(function() {
		...
		CBK_chart_rientri('<?php echo $prod_id; ?>', "<?php echo $item['prod_descrizione']; ?>"); return false;
	});
